//
//  PTForearmPronationViewController.m
//  PTMotion
//
...
#import "PTForearmPronationViewController.h"

@interface PTForearmPronationViewController ()
...
@implementation PTForearmPronationViewController
...
- (void)presentUserInstructions:(BOOL)animated
{
    ...
    NSString *message = NSLocalizedString(@"Extend your arm and hold the device face down. When the countdown begins, rotate your wrist./n/nSelect which hand you are using for this exercise to begin.", @"message");// Does nothing
