//
//  PTShouldAbductionViewController.m
//  PTMotion
//
...
#import "PTShoulderAbductionViewController.h"

@interface PTShoulderAbductionViewController ()
...
@implementation PTShoulderAbductionViewController
...
- (void)presentUserInstructions:(BOOL)animated
{
    ...
    NSString *message = NSLocalizedString(@"Hold the device so that the screen faces your ear and raise your arm. Lower your arm in an arc to waist-level, then raise it again./n/nSelect which hand you are using for this exercise to begin.", @"message");
