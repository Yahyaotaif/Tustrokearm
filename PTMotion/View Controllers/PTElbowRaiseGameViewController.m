//
//  PTElbowRaiseGameViewController.m
//  PTMotion
//
...
#import "PTElbowRaiseGameViewController.h"

// views
#import "MonkeyView.h"

@interface PTElbowRaiseGameViewController ()
...
@implementation PTElbowRaiseGameViewController

#pragma mark - Override
-(void) viewDidLoad{
    
    NSLog(@"The view loaded in frotate controller");
    [[NSUserDefaults standardUserDefaults] setInteger: 3 forKey:@"exerciseID"];
...
- (void)sessionStateDidChange:(PTSession*)context
{
    if (self.session.state == PTSessionStateActive) {
        ...
        NSUInteger x = [[NSUserDefaults standardUserDefaults] integerForKey:@"eRFcompCount"];
        x++;
        [[NSUserDefaults standardUserDefaults] setInteger: x forKey:@"eRFcompCount"];
